...
;;; bitemyapp-contrast-theme.el --- Emacs 24 theme with a dark background.

;; Copyright (C) 2014 , bitemyapp
...
(provide-theme 'bitemyapp-contrast)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; bitemyapp-contrast-theme.el ends here
