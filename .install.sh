...
# utilities
cargo install tokei hyperfine xsv diffr lsd hors starship mdcat strace-analyzer procs bingrep battop mprober ripgrep sd wasm-pack cargo-watch microserver cargo-crev cargo-edit
